...
def generate_image(pattern, file_name):
    """
    ...
    result.add(result.rect(insert=(0,0), size=(pattern.width.item(), pattern.height.item()), fill=pattern.colors[0]))
    ...
    draw_polygon_paths_vec(result, pattern)
